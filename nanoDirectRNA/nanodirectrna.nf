...
fast5_sample_4_modfinder.mix(fast5_control_4_modfinder).into{
	fast5_4_resquiggling; fast5_4_epinano
}
...
process resquiggling {
    ...
    input:
    set folder_name, idfile, multi5, file(fast5) from fast5_4_resquiggling
    file(reference)
    ...
    script:
	// conversion command if input is multi5
